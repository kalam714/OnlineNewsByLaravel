...
<div class="entity_wrapper">
    ...
    <div class="entity_content">
        ...
        <blockquote class="pull-left"> <img src="{{ asset('public/post')}}/{{$post->thumb_image}}"  alt="{{$post->title}}">
        </blockquote>
<p> {!! $post->description !!}
        </p>
    </div>
            ...
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <span class="media-date">
                         <a href="#">{{date('F j,Y',strtotime($news->created_at))}}</a>, by: <a href="{{url('/author')}}/{{$news->creator->id}}">{{$news->creator['name']}}</a></span>

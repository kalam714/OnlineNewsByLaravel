                          ...
                          <div id="pay-invoice">
                              <div class="card-body">
                                ...
                                @endif
                                  ...
                                  <hr>
{{ Form::open(array('url' => 'back/posts/store','method'=>'post','enctype'=>'multipart/form-data')) }}
 ...
 {{Form::label('category', 'Category', array('class' => 'control-label mb-1'))}}
   {{ Form::select('category_id',$categories,null,['class' =>'form-control myselect','data-placeholder'=>'Select Category'] ) }}
                    ...
                    {{Form::textarea('description',null,['class'=>'form-control my-editor','id'=>'descriptione'])}}

    ...
    public function store(Request $request)
    {
         $this->validate($request,[
            'name'=>'required|'
                ...
                'name.alpha_num'=>'Name fields Asccept Alpa Numeric Char'
            ]);
        ...
        $permission->display_name=$request->display_name;
         ...
         $permission->save();
         return redirect()->action('Admin\PermissionController@index')->with('success',"Permission Set SuccessFully");
    }
    ...
    public function update(Request $request, $id)
    {
       $this->validate($request,[
        ...
        $permission->display_name =$request->display_name;
         $permission->description =$request->description;
         $permission->save();
         return redirect()->action('Admin\PermissionController@index')->with('success',"Permission Update SuccessFully");
    }

            ...
            <div class="col-md-7">
                <div class="feature_article_wrapper">
                    ...
                    <div class="feature_article_inner">
                        ...
                        <div class="feature_article_date"><a href="{{url('/author')}}/{{$hot_news->creator->id}}" target="_self">{{$hot_news->creator->name}}</a>,<
                          <p>{{date('F j,Y',strtotime($hot_news->created_at))}}</p></div>
                        ...
                        <div class="article_social">
                            ...
                            <span><i class="fa fa-comments-o"></i><a href="#">{{$hot_news->comments_coun}}</a>Comments</span>
                        </div>
                        <!-- article_social -->
            ...
            <div class="col-md-5" style="margin-bottom: 3%">
                <div class="feature_static_wrapper">
                    ...
                    <div class="feature_article_inner">
                        ...
                        <div class="feature_article_date"><a href="{{url('/author')}}/{{$item->creator->id}}" target="_self">{{$item->creator->name}}</a>,<a href="#">
                                         
                           {{date('F j,Y',strtotime($item->created_at))}}</a></div>
                        <!-- feature_article_date -->
            ...
            <div class="col-md-6">
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <h3 class="{{url('details')}}/{{$item->slug}}">{{$item->title}} </a></h3>
